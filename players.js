...
function findHighComps (me) {
  return tier1.filter(function(v, i) {
    return (v.shooting == me.shooting && v.ballhandling == me.ballhandling && v.defense == me.defense && v.passing == me.passing && v.rebounding == me.rebounding && v.scoring == me.scoring)
  })
}

function findLowComps (me) {
  return tier2.filter(function(v, i) {
    return (v.shooting == me.shooting && v.ballhandling == me.ballhandling && v.defense == me.defense && v.passing == me.passing && v.rebounding == me.rebounding && v.scoring == me.scoring)
  })
}
